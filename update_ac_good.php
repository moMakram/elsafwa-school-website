...
if($_FILES["file"]["size"]=='')
{
$result = mysql_query(" update good set descr ='$_POST[descr]'
  where id='$_POST[id]' " );
}else{

$result = mysql_query(" update pic set descr ='$_POST[descr]' , file ='$imname' 
  where id='$_POST[id]' " );
...
window.location ="deleteorupdategood.php";
</script>
</body>
</html>
');
