...
if($_FILES["file"]["size"]=='')
{
$result = mysql_query(" update pic set ordere ='$_POST[ordere]'  , descr ='$_POST[descr]' , place = '$_POST[place]'
  where id='$_POST[id]' " );
}else{

$result = mysql_query(" update pic set ordere ='$_POST[ordere]'  , descr ='$_POST[descr]' , file ='$imname' , place = '$_POST[place]'
  where id='$_POST[id]' " );
...
window.location ="deleteorupdatepict.php";
</script>
</body>
</html>
');
