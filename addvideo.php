...
echo('
<div id="body2">
<form id="form1" name="form1" method="post" action="ins_video.php" enctype="multipart/form-data">
  <table width="480" height="150" border="0" bordercolor="#000" style="margin-left:144px; margin-top:30px;">
    ...
    <tr>
      <td width="150" style="background:#000" align="center"><font color="#FFFFFF" face="Comic Sans MS, cursive">وصف الفيديو</font></td>
