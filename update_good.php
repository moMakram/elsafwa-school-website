...
$result = mysql_query(" select * from good where id ='$id' ");
...
<title>التعديل على ملف الجوده</title>
...
<div id="bodymm">
<form id="form1" name="form1" method="POST" enctype="multipart/form-data" action="update_ac_good.php">
<br/><br/>
