...
$result = mysql_query(" select * from class where id ='$id' ");
...
<div id="body2">
<form id="form1" name="form1" method="post" action="update_ac_cls.php">
<br/><br/>
<table width="480" height="50" border="0" bordercolor="#000" style="margin-left:144px; margin-top:30px;">
  ...
  <tr>
    ...
    <td style="background-color:#060"><input name="classname" type="text"  value=" '); echo $rows['classname'] ; echo('"
