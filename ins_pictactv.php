...
$resul = mysql_query(" select * from active where name='$active'");

$rowses = mysql_fetch_array($resul);

$idactive=$rowses['id'];



   $result = mysql_query("INSERT INTO pictactive (descr,idactive,file)
 values('$_POST[descr]','$idactive', '$imname')");
...
window.location ="addpictactv.php";
</script>
</body>
</html>
');
