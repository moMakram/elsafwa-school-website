...
include ("connec.php");
  ...
  $result2 = mysql_query(" select * from section");
 
echo('<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>اضافه الشيت</title>
...
echo('
<div id="body2">
<form id="form1" name="form1" method="post" action="ins_sheet.php" enctype="multipart/form-data">
  <table width="480" height="150" border="0" bordercolor="#000" style="margin-left:144px; margin-top:30px;">
   ...
   <tr>
      ...
      <td style="background-color:#060"><select name="material" id="group_n"  style=" border:none;margin-left:6px; margin-top:2px; width:307px; height:20px;">
        <option>-----</option>');
		 $result = mysql_query(" select * from prevsheet where idte='$_SESSION[id8]' ");
		      while ( $rows = mysql_fetch_array($result) )
  {
  echo('
        <option>');echo($rows['matname']);echo('</option>
		');
		}
		echo('
      </select></td>
    ...
    <tr>
      ...
      <td style="background-color:#060"><select name="section" id="group_n"  style=" border:none;margin-left:6px; margin-top:2px; width:307px; height:20px;">
        <option>-----</option>');
		      while ( $ro = mysql_fetch_array($result2) )
  {
  echo('
        <option>');echo($ro[1]);echo('</option>
		');
		}
		echo('
      </select></td>
	  ...
	  <tr>
      <td width="150" style="background:#000" align="center"><font color="#FFFFFF" face="Comic Sans MS, cursive">الوصف</font></td>
