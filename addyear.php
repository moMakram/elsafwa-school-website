...
echo('
<div id="body2">
<form id="form1" name="form1" method="post" action="ins_year.php">
<br/><br/>
  <table width="430" height="50" border="0" bordercolor="#000" style="margin-left:144px; margin-top:30px;">
    <tr>
      <td width="100"  style="background:#000" align="center"><font color="#FFFFFF" face="Comic Sans MS, cursive">اسم السنه</font></td>
