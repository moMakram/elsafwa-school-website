...
echo('
<div id="body2">
<form id="form1" name="form1" method="post" action="ins_cls.php">
<br/><br/>
  <table width="430" height="50" border="0" bordercolor="#000" style="margin-left:144px; margin-top:30px;">
    <tr>
      <td width="100"  style="background:#000" align="center"><font color="#FFFFFF" face="Comic Sans MS, cursive">الفصل</font></td>
      <td style="background-color:#060"><input name="classname" type="text" style=" border:none;margin-left:6px; margin-top:2px; width:307px; height:20px;"/></td>
    </tr>
